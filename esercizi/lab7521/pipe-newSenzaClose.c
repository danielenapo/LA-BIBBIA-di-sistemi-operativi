...
int main (int argc, char** argv){
    ...
    if (pid == 0){/* figlio */
        ...
        while (read(fd, mess, MSGSIZE)){/*  il  padre  ha  concordato  con  il  figlio  che  gli  mandera'  solo  stringhe  e  quindi dobbiamo sostituire il terminatore di linea con il terminatore di stringa */
            mess[MSGSIZE-1]='\0';
